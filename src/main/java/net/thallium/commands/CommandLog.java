...
import net.thallium.logging.LogHandler;
import net.thallium.logging.Logger;
import net.thallium.logging.LoggerRegistry;
import net.thallium.utils.Messenger;
...
public class CommandLog extends CommandThalliumBase {
	@Override
